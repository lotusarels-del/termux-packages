...
termux_step_make_install() {
	...
	local LOADER_URL="https://github.com/lotusarels-del/termux-packages/releases/download/untagged-bf4b42109ce79f3cc53f/termux-x11-nightly-1.03.01-0-any.pkg.tar.xz"
